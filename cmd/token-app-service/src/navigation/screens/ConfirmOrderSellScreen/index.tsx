/**
 * ConfirmOrderSellScreen - 出售確認訂單頁面
 */
...
type ConfirmOrderSellRouteProp = RouteProp<{ 
  ConfirmOrderSell: { 
    orderNumber: string;
    amount: number;
    totalPrice: number;
...
export default function ConfirmOrderSellScreen() {
  const navigation = useNavigation();
  const route = useRoute<ConfirmOrderSellRouteProp>();
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <View style={styles.timerContainer}>
            ...
            <Text style={styles.timerHint}>等待買家付款</Text>
          </View>
        </View>
        ...
        {/* 您的收款資訊 */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>您的收款資訊</Text>
          <View style={styles.row}>
          ...
          <Text style={styles.hintWarning}>
            請確認收到款項後再點擊「確認收款並放行」，切勿在未收到款項前放行
          </Text>
        </View>
        ...
        <View style={styles.buttonContainer}>
          ...
          >
            <Text style={styles.primaryButtonText}>確認收款並放行</Text>
          </Pressable>
          <Pressable 
            style={({ pressed }) => [
